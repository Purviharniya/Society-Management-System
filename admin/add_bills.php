                    ...
                    <form action="includes/queries/addbill.php" method="POST" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="block" name="block" aria-describedby="blockHelp"
                                required>
                            <small id="blockHelp" class="form-text text-muted">Select the block name (make dropdown)</small>
                        </div>
                        <div class="form-group">
                            ...
                            <small id="flatnoHelp" class="form-text text-muted">Select the flat Number (Make dropdown)</small>
                        </div>
