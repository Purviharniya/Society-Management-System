                                            ...
                                            <form method="POST" enctype="multipart/form-data" id="bulkUploadInternal">
                                                ...
                                                <div class="form-row mt-4">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="flatno"
                                                            name="flatno" value="flatno"
                                                            placeholder="Column name of Flat number" required>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input type="text" class="form-control" id="vname" name="vname"
                                                            value="vname" placeholder="Column name of Visitor Name"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="contact"
                                                            ...
                                                            placeholder="Column name of Contact no" required>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="whomToMeet"
                                                        ...
                                                        placeholder="Column name of whom to meet" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="reasonToMeet">Reason to Meet:</label>
                                                    <textarea class="form-control" id="reasonToMeet" name="reasonToMeet"
                                                        value="reasonToMeet" placeholder="Column name of whom to meet"
