        ...
        <div class="col-md-12 grid-margin stretch-card mt-2">
            <div class="card pt-1 pb-5">
                <div class="card-body">
                    ...
                    <!-- Modal for importing -->
                    <div class="modal fade" id="uploadarea" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle0" aria-hidden="true">
                                            ...
                                            <form method="POST" enctype="multipart/form-data" id="bulkUploadInternal">
                                                ...
                                                <div class="form-row mt-4">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="block" placeholder="Column name of Block" name="block" value="block" required>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="eid"><b>Flat Series</b></label>
                                                        <input type="text" class="form-control" id="series" placeholder="Column name of Flat Series" name="series" value="series" required>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" class="btn btn-primary" name="save_changes" id="upload_farea">Upload</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
