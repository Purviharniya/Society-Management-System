...
$cmd = ' python addallotments.py "' . $addedby . '"
" ' . $timestamp . '" "' . $fno . '""' . $block . '" 
"' . $oname . '" "' . $oemail . '" "' . $ocontact . '" 
"' . $oacontact . '" "' . $omembers . '" "' . $isRent . '"
"' . $rname . '" "' . $remail . '" "' . $rcontact . '" 
"' . $racontact . '" "' . $rmembers . '" "' . $servername . '" 
"' . $target_location . '" "' . $username . '" "' . $dbname . '"
"' . $password . '" "' . $upload_constraint . '" "' . $login_role . '" ';
echo $cmd;
