...
?>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <?php
$flatno = array();
$query = "SELECT distinct(FlatNumber) FROM visitors";
if ($result = mysqli_query($con, $query)) {
    $rowcount = mysqli_num_rows($result);
    while ($row = mysqli_fetch_array($result)) {
        $flatno = $row['FlatNumber'];
        echo '<div class="custom-control custom-checkbox custom-control-inline">
                                                            <input checked type="checkbox" name="filter_flatno[]" class="custom-control-input" value="' . $flatno . '" id="filter_flatno_' . $flatno . '">
                                                            <label class="custom-control-label" for="filter_flatno_' . $flatno . '">' . $flatno . '</label>
                                                        </div>';
    }
}
?>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <?php
$vname = array();
$query = "SELECT distinct(VisitorName) FROM visitors";
if ($result = mysqli_query($con, $query)) {
    $rowcount = mysqli_num_rows($result);
    while ($row = mysqli_fetch_array($result)) {
