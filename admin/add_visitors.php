...
=======
                        ...
                        <form action="includes/queries/visitors.php" method="POST" autocomplete="">
                            <div class="form-group">
                                ...
                                <small id="blockHelp" class="form-text text-muted">Enter the block name (make it a drop
                                    down
                                    later)</small>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="fno" name="fno" aria-describedby="fnoHelp"
                                    required>
                                <small id="fnoHelp" class="form-text text-muted">Enter the Flat number (make it a drop
                                    down
                                    later)</small>
                            </div>
>>>>>>> e6295cb3e1bf20db9615e1721fb3c5f383694900
