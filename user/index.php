...
$bill_sql = mysqli_query($con, "SELECT * from bills where FlatID='$flatid';");
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card mt-2">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title font-weight-bold text-info">Dashboard:
                                ...
                                <div class="card-body row justify-content-center align-items-center text-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card-heading align-self-center font-weight-bold"
                                            ...
                                            <span class="counter" data-target='<?php echo $meetings; ?>'>0</span> <br>
                                            Meetings
                                        </div>
                                    </div>
                                </div>
