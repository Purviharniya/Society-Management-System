...
$cmd = 'python addvisitors.py "' . $addedby . '" "' . $timestamp . '" "' . $vname . '" "' . $contact . '" "' . $contact1 . '" "' . $block . '" "' . $flatno . '" "' . $whomToMeet . '" "' . $reasonToMeet . '" "' . ' ' . '" "' . $servername . '" "' . $target_location . '" "' . $username . '" "' . $dbname . '" "' . $password . '" "' . $upload_constraint . '" "' . $login_role . '" ';
echo $cmd;
